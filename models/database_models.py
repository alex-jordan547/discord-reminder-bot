...
from models.validation import FieldValidator, SerializationMixin, ValidationMixin
...
class User(BaseModel):
    ...
    class Meta:
        indexes = ((("user_id", "guild"), True),)  # Unique constraint per guild
...
class Event(BaseModel):
    ...
    def validate_data(self) -> List[str]:
        ...
        if self.required_reactions:
            errors.extend(
                FieldValidator.validate_json_field(self.required_reactions, "required_reactions")
            )
            ...
            try:
                ...
                if not reactions:
                    ...
                    for emoji in reactions:
                        errors.extend(
                            FieldValidator.validate_emoji(emoji, f"required_reaction '{emoji}'")
                        )
    ...
    try:
        ...
        for model in ALL_MODELS:
            ...
            try:
                ...
                info[table_name] = {"model": model.__name__, "row_count": count, "exists": True}
            except Exception as e:
                info[table_name] = {
