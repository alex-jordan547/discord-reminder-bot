...
from models.database_models import ALL_MODELS, create_tables, drop_tables, get_table_info
...
class DatabaseManager:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            total_records = sum(
                info.get("row_count", 0) for info in table_info.values() if isinstance(info, dict)
            )
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if health["database_available"]:
                ...
                existing_tables = sum(
                    1
                    for info in health["table_info"].values()
