...
class AlertManager:
    ...
    def _load_default_config(self) -> Dict:
        ...
        return {
            ...
            "file": {
                "enabled": True,
                "path": os.getenv("ALERT_LOG_PATH", "alerts.log")
            },
            "console": {
                "enabled": True
            },
            "alert_levels": {
                ...
                "file": [AlertLevel.INFO, AlertLevel.WARNING, AlertLevel.ERROR, AlertLevel.CRITICAL],
                "console": [AlertLevel.INFO, AlertLevel.WARNING, AlertLevel.ERROR, AlertLevel.CRITICAL]
            }
        }
...
This is an automated alert from the Discord Reminder Bot monitoring system.
    ...
    def get_alert_summary(self) -> Dict:
        ...
        for alert in recent_alerts:
            ...
            # Count by component
            summary["by_component"][alert.component] = summary["by_component"].get(alert.component, 0) + 1
