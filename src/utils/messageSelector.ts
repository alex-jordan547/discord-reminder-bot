...
export function createMessageSelectionEmbed(messageCount: number): EmbedBuilder {
  return new EmbedBuilder()
    ...
    .addFields(
      ...
      {
        name: '💡 Tip',
        value: 'You can still use `/watch` with a message link for specific messages from other channels!',
        inline: false,
      }
    )
 ...
 */
export function createTimeSelectMenu(
  customId: string = 'select_time',
): StringSelectMenuBuilder {
