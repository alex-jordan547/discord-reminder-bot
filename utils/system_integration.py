...
class ServiceRegistry:
    ...
    def get_service(self, service_name: str, **kwargs) -> Optional[Any]:
        ...
        sorted_impls = sorted(implementations.items(), key=lambda x: x[1]["priority"], reverse=True)
    ...
    def get_service_info(self, service_name: str) -> Dict[str, Any]:
        ...
        for impl_name, impl_info in self._services[service_name].items():
            ...
            info[impl_name] = {
                ...
                "available": available,
                "active": available
                and impl_info["priority"]
                == max(
                    i["priority"]
                    for i in self._services[service_name].values()
        ...
        while self._monitoring_active:
            try:
                ...
                if is_healthy:
                    ...
                    self._health_status[component_name]["consecutive_failures"] = check_info[
...
class SystemIntegrator:
    ...
    async def _register_core_services(self) -> None:
        ...
        self.service_registry.register_service(
            "storage", "json", JSONStorageBackend, feature_flag=None, priority=1
        )
    ...
    async def _setup_health_monitoring(self) -> None:
        ...
        self.health_monitor.register_health_check(
            "feature_flags", check_feature_flags, check_interval=60, failure_threshold=1  # 1 minute
        )
