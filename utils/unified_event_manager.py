...
class UnifiedEventManager:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            self._storage_adapter = StorageAdapter(
                json_path=Settings.REMINDERS_SAVE_FILE,
            ...
            logger.info(f"Unified event manager initialized with {self._storage_adapter.get_current_backend_type()} backend")
            return True
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'backend_type': self._storage_adapter.get_current_backend_type() if self._storage_adapter else 'Unknown',
